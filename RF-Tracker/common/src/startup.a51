...
;     FILE:       startup.a51
;     TARGET:     Si4010
;     TOOLCHAIN:  Keil, Raisonance using User defined Startup
;     DATE:       May 18, 2010, Tuesday
;     RELEASE:    2.2 (MPech), ROM version 02.00
;
;---------------------------------------------------------------------------
;
;       DESCRIPTION:
...
;         Version 8.01
;
;         For Raisonance one has to set the User defined Startup and must
;         manually locate the stack for Si4010 as shown below:
;
;         RIDE: Options -> Project -> LX51 -> Startup -> User defined Startup
;         RIDE: Options -> Project -> LX51 -> More: IDATA(?STACK(0xC0))
;
;         The value 0xC0 is an example and is up to the user to change
;         that value.
;
